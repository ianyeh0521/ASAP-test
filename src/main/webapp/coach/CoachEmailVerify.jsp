...
<%  
    ...
    Object coachNo = session.getAttribute("coachNo");
     
    if(coachNo == null){
    	pageContext.setAttribute("msg","您的帳號已驗證。");
    	
    } else{
    	CoachVO cVO = coachSvc.findByPK((String)coachNo);
    	pageContext.setAttribute("coachEmail",cVO.getCoachEmail());
    	pageContext.setAttribute("coachNo",cVO.getCoachNo());
    	pageContext.setAttribute("coachName",cVO.getCoachName());
						...
						<div class="row" style="justify-content: center">
							<div class="col-md-6"
								style="margin: 30px; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;">
                                 <div style="margin:15px 0px 10px 0px">您註冊的帳號為 : ${coachEmail}。請點擊下方按鈕取得驗證信。</div>
	...
	<script>
			...
			$(window).on("load", function(){
				...
				$("#genVerifyCode").on("click", function(){
					...
					$.ajax({
						  url: "${pageContext.request.contextPath}/CoachSendMail",           // 資料請求的網址
						  type: "POST",                 
						  data: {
		                        action: "verifyEmail",
