	...
	$(document).ready(function() {
		$("#table_id").DataTable({
			...
			"columns" : [
				...
				{"data" : "OrderCrtTime","title" : "訂購時間",}, 
				{"data" : "ItemOrderQty","title" : "訂購數量",},
				{"data" : "ItemOrderPrice","title" : "訂購單價",},
				{"data" : "DelyStat","title" : "出貨狀態",}, 
				{"data" : null ,"title" : "出貨",}, ],
			
			"columnDefs" : [
				{targets : [1, 2, 3, 4, 5, 6, 7, 8],width : "11%", // 設定寬度
				},
				{targets : [0, 9],width : "6%", // 設定寬度
				},
				{data: null,
	             defaultContent: '<button class="btn btn-primary btn-sm" style="border-radius: 5px;">出貨</button>',
	             targets: -1
	            },
				],
		   });
		...
		$(window).on("load",function() {
				...
				$('#table_id tbody').on('click','td.details-control',function() {
					...
					dataTable.on('click','button',function(e) {
							...
							if (data.DelyStat == "未出貨") {

				            	 var yes = confirm("出貨單編號" + data.OrderDetailNo + "是否已出貨?");
