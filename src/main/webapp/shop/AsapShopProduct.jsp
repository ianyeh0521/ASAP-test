        ...
        <main class="main">
            <div class="container">
                <nav aria-label="breadcrumb" class="breadcrumb-nav">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="asapshop.html"><i class="icon-home">商城首頁</i></a></li> 
                        <li class="breadcrumb-item"><a href="asapshopproduct.html">足球</a></li>
                    </ol>
                </nav>

                <div class="product-single-container product-single-default">
                    <div class="cart-message d-none">
                        <strong class="single-cart-notice">“足球”</strong>
                        <span>已經加入到您的購物車裡.</span>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-6 product-single-details">
                            ...
                            <div class="product-desc">
                                <p>
                                    這顆二手足球是2023世界盃冠軍賽踢的，現在特價只要200元!!。
                                </p>
                            ...
                            <ul class="single-info-list">
                                ...
                                <li>
                                    上架時間:
                                    <strong>
                                        <a href="#" class="product-category">2023/08/28</a>
                                    </strong>
                                </li>
                                <li>
                                    商品狀態:
                                    <strong>
                                        <a href="#" class="product-category">狀況尚可</a>
                                    </strong>
                                </li>
                                <li>
                                    庫存數量:
                                    <strong>
                                        <a href="#" class="product-category">2</a>
                                    </strong>
                                </li>
                                <li>
                                    賣家:
                                    <strong>
                                        <a href="#" class="product-category">M123</a>
                                    </strong>
                                </li>
                                <li>
                                    瀏覽人數:
                                    <strong>
                                        <a href="#" class="product-category">5,000</a>
                                    </strong>
                                </li>
                            ...
                            <div class="product-action">
                                ...
                                <a href="javascript:;" class="btn btn-dark add-cart mr-2" title="Add to Cart">加入購物車</a>

                                <a href="asapcart.html" class="btn btn-gray view-cart d-none">查看購物車</a>
                            ...
                            <div class="product-single-share mb-2">
                                ...
                                <a href="asapshopwish.html" class="btn-icon-wish add-wishlist" title="加入我的收藏"><i
                                        class="icon-wishlist-2"></i><span>加入我的收藏</span></a>
                        ...
                        <div class="tab-pane fade show active" id="product-desc-content" role="tabpanel"
                            ...
                            <div class="product-desc-content">
                                ...
                                <ul>
                                    <li>商品狀態 -狀況商可</li>
                                    <li>安全支付選項</li>
                                    <li>依據售出商品屬於個人衛生或特殊性質，故無法提供換貨服務。
                                    </li>
                                </ul>
