  ...
  <div class="page-wrapper">
    ...
    <div class="forum-options">
      <div class="forum-buttons">
        ...
        <button type="submit" class="forum-button btn btn-default btn-rounded btn-md">最新發表</button>
        <button type="submit" class="forum-button btn btn-default btn-rounded btn-md">熱門文章</button>
        <select class="forum-dropdown btn-default btn-md" name="select-theme" style="height: 38px; width:90px;">
      ...
      <div class="user-buttons">
        <a href="./testing_summernote.html" style="color:black"><button type="submit"
    ...
    <div class="forum-post">
      <div class="post-content">
        <span class="category-tag">${postVO.postTypeNo}</span>
        <h2 class="post-title">${postVO.postTitle}</h2>
