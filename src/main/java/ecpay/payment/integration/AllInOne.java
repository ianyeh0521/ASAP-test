...
public class AllInOne extends AllInOneBase{
	 ...
	 * @param String
	 */
	// Obj 中 PaymentType, ChoosePayment, EncryptType 屬性忽略，SDK 會自動帶入，非特約合作平台商勿填寫 MerchantID；InvoiceObj 不開發票的話帶入 null
	// 物件內所有屬性質都為 String，請勿放入 null 或其他非法型態，此方法回傳 html form 由 JavaScript submit 的 String，放在網頁上即可（PrintWriter）
